...
function locationInfo() {
    ...
    this.confCity = function(id) {
     //   console.log(id);
     //   console.log('started');
        var url = rootUrl+'?type=confCity&countryId=IN&stateId=' + jQuery('#stateId option:selected').attr('stateid') + '&cityId=' + id;
        var method = "post";
        var data = {};
    ...
    this.getCities = function(id) {
        jQuery(".mycity option:gt(0)").remove();
        ...
        var method = "post";
        var data = {};
        jQuery('.mycity').find("option:eq(0)").html("Please wait..");
        call.send(data, url, method, function(data) {
            jQuery('.mycity').find("option:eq(0)").html("Select City");
            if(data.tp == 1){
                ...
                jQuery(".mycity").prop("disabled",false);
            }
            else{
                alert(data.msg);
            }
    ...
    this.getStates = function(id) {
        ...
        var url = rootUrl+'?type=getStates&countryId=IN' + addParams  + addClasses;
        var method = "post";
        var data = {};
...
jQuery(function() {
  ...
  //  });
    ...
    jQuery(".mycity").on("change", function(ev) {
